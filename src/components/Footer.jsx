...
const footerData = [
  ...
  },
  {
    ...
    items: ['Organization Team', 'Our Journeys', 'Pricing Plans', 'Roadmap', 'Terms & Conditions', 'Privacy Policy']
  },
  {
    title: 'Company',
    ...
    <footer>
      <div className="pt-10  lg:pt-20 lg:pb-12 bg-customDarkBg1 radius-for-skewed ">
        <div className="container mx-auto px-4 w-4/5 md:w-11/12 lg:w-10/12 xl:w-4/5 2xl:w-2/3">
          ...
          <p className="lg:text-center text-sm text-gray-400 border-t border-[rgb(255,255,255,0.2)] pt-12 mt-16 hidden lg:block">&copy; 2022. MIT license.</p>
        </div>
      </div>
    </footer>
  )
